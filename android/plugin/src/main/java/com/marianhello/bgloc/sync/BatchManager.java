...
public class BatchManager {
    ...
    public File createBatch(Long batchStartMillis, Integer syncThreshold) throws IOException {
        ...
        log.info("Sync threshold : {}", syncThreshold);
        ...
        log.info("DB String : {}", whereClause);

        String[] whereArgs = { "1", String.valueOf(batchStartMillis) };
        // String[] whereArgs = null;
        String groupBy = null;
        String having = null;
        String orderBy = SQLiteLocationContract.LocationEntry.COLUMN_NAME_TIME + " DESC LIMIT 1";
        // String orderBy = null;
        ...
        try {
            ...
            File file = File.createTempFile("location", ".json");
            ...
            // db.update(SQLiteLocationContract.LocationEntry.TABLE_NAME, values, whereClause);
